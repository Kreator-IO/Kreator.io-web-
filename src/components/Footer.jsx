        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex gap-4 mb-4">
              ...
              <a href="https://github.com/Kreator-IO" target="_blank" rel="noopener noreferrer" className="hover:text-blue-200 transition">
                <Github size={24} />
              </a>
              <a href="https://x.com/IoKreator26102" target="_blank" rel="noopener noreferrer" className="hover:text-blue-200 transition">
                <Twitter size={24} />
              </a>
              <a href="mailto:Kreator_IO@proton.me" className="hover:text-blue-200 transition">
                <Mail size={24} />
              </a>
            </div>
            <p className="text-blue-100">Kreator_IO@proton.me</p>
          </div>
        </div>
